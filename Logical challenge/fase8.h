...
int fase8(int pontuacao)
{
    ...
    fundo = al_load_bitmap("recursos/pergunta8/pergunta.jpg");/**FUNDO RECEBE IMAGEM E SUA LOCALIZACAO DE ONDE ELA ESTA**/
    ...
    /**ATRIBUINDO IMAGEM*/
    resposta1=al_load_bitmap("recursos/pergunta8/resposta1.png");
    resposta11=al_load_bitmap("recursos/pergunta8/resposta11.png");
    resposta2=al_load_bitmap("recursos/pergunta8/resposta2.png");
    resposta22=al_load_bitmap("recursos/pergunta8/resposta22.png");
    resposta3=al_load_bitmap("recursos/pergunta8/resposta3.png");
    resposta33=al_load_bitmap("recursos/pergunta8/resposta33.png");
    resposta4=al_load_bitmap("recursos/pergunta8/resposta4.png");
    resposta44=al_load_bitmap("recursos/pergunta8/resposta44.png");
    resposta5=al_load_bitmap("recursos/pergunta8/resposta5.png");
    resposta55=al_load_bitmap("recursos/pergunta8/resposta55.png");
    resposta_correta=al_load_bitmap("recursos/pergunta8/respostacorreta.png");

    /**ONDE A IMAGENS IRA SE POSICIONAR*/
    al_draw_bitmap(resposta1, LARGURA*0.144, ALTURA*0.495,0);
    ...
    al_draw_bitmap(resposta5, LARGURA*0.144, ALTURA*0.918,0);
    al_flip_display();
    ...
    while(!sair)/**SAIR JO JOGO*/
    {
        ...
        {
            al_draw_bitmap(resposta11, LARGURA*0.144, ALTURA*0.495,0);
        }
        al_flip_display();///ATUALIZA A TELA

        if(evento.type == ALLEGRO_EVENT_MOUSE_AXES)
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta1) && evento.mouse.y> ALTURA*0.495 && evento.mouse.y < ALTURA*0.495 + al_get_bitmap_height(resposta1))
            {
                opcao1=false;
            }
            else
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)///CASO CLIQUE NA RESPOSTA
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.495 && evento.mouse.y < ALTURA*0.495 + al_get_bitmap_height(resposta1))
                {
        ...
        {
            al_draw_bitmap(resposta55, LARGURA*0.144, ALTURA*0.918,0);
        }
        al_flip_display();
        if(evento.type == ALLEGRO_EVENT_MOUSE_AXES)
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta5) && evento.mouse.y> ALTURA*0.918 && evento.mouse.y < ALTURA*0.918 + al_get_bitmap_height(resposta5))
            {
                opcao5=false;
            }
            else
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)/**SE CLICAR NA PERGUNTA*/
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.918 && evento.mouse.y < ALTURA*0.918 + al_get_bitmap_height(resposta5))
                {
                    ponto=0;
                }
            }
        ...
        switch (ponto)///SE RESPOSTA ESTIVER ERRADA MOSTRAR A CORRETA
            ...
            case 0:
                ...
                al_draw_bitmap(resposta_correta,LARGURA*0.144, ALTURA*0.707,0);///RESPOSTA CORRETA
                al_flip_display();
