...
int fase5(int pontuacao)
{
    ...
    fundo = al_load_bitmap("recursos/pergunta5/pergunta.jpg");/**FUNDO RECEBE IMAGEM E SUA LOCALIZACAO DE ONDE ELA ESTA**/
    ...
    /**ATRIBUINDO IMAGEM*/
    resposta1=al_load_bitmap("recursos/pergunta5/resposta1.png");
    resposta11=al_load_bitmap("recursos/pergunta5/resposta11.png");
    resposta2=al_load_bitmap("recursos/pergunta5/resposta2.png");
    resposta22=al_load_bitmap("recursos/pergunta5/resposta22.png");
    resposta3=al_load_bitmap("recursos/pergunta5/resposta3.png");
    resposta33=al_load_bitmap("recursos/pergunta5/resposta33.png");
    resposta4=al_load_bitmap("recursos/pergunta5/resposta4.png");
    resposta44=al_load_bitmap("recursos/pergunta5/resposta44.png");
    resposta5=al_load_bitmap("recursos/pergunta5/resposta5.png");
    resposta55=al_load_bitmap("recursos/pergunta5/resposta55.png");
    resposta_correta=al_load_bitmap("recursos/pergunta5/respostacorreta.png");

    /**ONDE A IMAGENS IRA SE POSICIONAR*/
    al_draw_bitmap(resposta1, LARGURA*0.144, ALTURA*0.495,0);
    al_draw_bitmap(resposta2, LARGURA*0.144, ALTURA*0.6,0);
    al_draw_bitmap(resposta3, LARGURA*0.144, ALTURA*0.706,0);
    al_draw_bitmap(resposta4, LARGURA*0.144, ALTURA*0.811,0);
    al_draw_bitmap(resposta5, LARGURA*0.144, ALTURA*0.917,0);
    al_flip_display();
    ...
    while(!sair)/**SAIR JO JOGO*/
    {
        ...
        {
            al_draw_bitmap(resposta22, LARGURA*0.144, ALTURA*0.6,0);
        }
        al_flip_display();
        if(evento.type == ALLEGRO_EVENT_MOUSE_AXES)
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta2) && evento.mouse.y> ALTURA*0.6 && evento.mouse.y < ALTURA*0.6 + al_get_bitmap_height(resposta2))
            {
                opcao2=false;
            }
            else
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.6 && evento.mouse.y < ALTURA*0.6 + al_get_bitmap_height(resposta2))
                {
        ...
        {
            al_draw_bitmap(resposta33, LARGURA*0.144, ALTURA*0.706,0);
        }
        al_flip_display();
        if(evento.type == ALLEGRO_EVENT_MOUSE_AXES)
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta3) && evento.mouse.y> ALTURA*0.706 && evento.mouse.y < ALTURA*0.706 + al_get_bitmap_height(resposta3))
            {
                opcao3=false;
            }
            else
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.706 && evento.mouse.y < ALTURA*0.706 + al_get_bitmap_height(resposta4))
                {
        ...
        {
            al_draw_bitmap(resposta55, LARGURA*0.144, ALTURA*0.917,0);
        }
        al_flip_display();
        if(evento.type == ALLEGRO_EVENT_MOUSE_AXES)
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta5) && evento.mouse.y> ALTURA*0.917 && evento.mouse.y < ALTURA*0.917 + al_get_bitmap_height(resposta5))
            {
                opcao5=false;
            }
            else
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)/**SE CLICAR NA PERGUNTA*/
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.917 && evento.mouse.y < ALTURA*0.917 + al_get_bitmap_height(resposta5))
                {
                    ponto=0;
                }
            }
        ...
        switch (ponto)///SE RESPOSTA ESTIVER ERRADA MOSTRAR A CORRETA
            ...
            case 0:
                ...
                al_draw_bitmap(resposta_correta,LARGURA*0.144, ALTURA*0.6,0);///RESPOSTA CORRETA
                al_flip_display();
