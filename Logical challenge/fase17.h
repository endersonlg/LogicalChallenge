...
int fase17(int pontuacao)
{
    ...
    fundo = al_load_bitmap("recursos/pergunta17/pergunta.jpg");/**FUNDO RECEBE IMAGEM E SUA LOCALIZACAO DE ONDE ELA ESTA**/
    ...
    /**ATRIBUINDO IMAGEM*/
    resposta1=al_load_bitmap("recursos/pergunta17/resposta1.png");
    resposta11=al_load_bitmap("recursos/pergunta17/resposta11.png");
    resposta2=al_load_bitmap("recursos/pergunta17/resposta2.png");
    resposta22=al_load_bitmap("recursos/pergunta17/resposta22.png");
    resposta3=al_load_bitmap("recursos/pergunta17/resposta3.png");
    resposta33=al_load_bitmap("recursos/pergunta17/resposta33.png");
    resposta4=al_load_bitmap("recursos/pergunta17/resposta4.png");
    resposta44=al_load_bitmap("recursos/pergunta17/resposta44.png");
    resposta5=al_load_bitmap("recursos/pergunta17/resposta5.png");
    resposta55=al_load_bitmap("recursos/pergunta17/resposta55.png");
    resposta_correta=al_load_bitmap("recursos/pergunta17/respostacorreta.png");
    ...
    while(!sair)/**SAIR JO JOGO*/
    {
        ...
        switch (ponto)///SE RESPOSTA ESTIVER ERRADA MOSTRAR A CORRETA
            ...
            case 0:
                ...
                al_draw_bitmap(resposta_correta,LARGURA*0.144, ALTURA*0.916,0);///RESPOSTA CORRETA
                al_flip_display();
