...
int fase4(int pontuacao)
{
    ...
    fundo = al_load_bitmap("recursos/pergunta4/pergunta.jpg");/**FUNDO RECEBE IMAGEM E SUA LOCALIZACAO DE ONDE ELA ESTA**/
    ...
    /**ATRIBUINDO IMAGEM*/
    resposta1=al_load_bitmap("recursos/pergunta4/resposta1.png");
    resposta11=al_load_bitmap("recursos/pergunta4/resposta11.png");
    resposta2=al_load_bitmap("recursos/pergunta4/resposta2.png");
    resposta22=al_load_bitmap("recursos/pergunta4/resposta22.png");
    resposta3=al_load_bitmap("recursos/pergunta4/resposta3.png");
    resposta33=al_load_bitmap("recursos/pergunta4/resposta33.png");
    resposta4=al_load_bitmap("recursos/pergunta4/resposta4.png");
    resposta44=al_load_bitmap("recursos/pergunta4/resposta44.png");
    resposta5=al_load_bitmap("recursos/pergunta4/resposta5.png");
    resposta55=al_load_bitmap("recursos/pergunta4/resposta55.png");
    resposta_correta=al_load_bitmap("recursos/pergunta4/respostacorreta.png");
    ...
    while(!sair)/**SAIR JO JOGO*/
    {
        ...
        switch (ponto)///SE RESPOSTA ESTIVER ERRADA MOSTRAR A CORRETA
            ...
            case 0:
                ...
                al_draw_bitmap(resposta_correta,LARGURA*0.144, ALTURA*0.917,0);///RESPOSTA CORRETA
                al_flip_display();
