...
int fase11(int pontuacao)
{
    ...
    fundo = al_load_bitmap("recursos/pergunta11/pergunta.jpg");/**FUNDO RECEBE IMAGEM E SUA LOCALIZACAO DE ONDE ELA ESTA**/
    ...
    /**ATRIBUINDO IMAGEM*/
    resposta1=al_load_bitmap("recursos/pergunta11/resposta1.png");
    resposta11=al_load_bitmap("recursos/pergunta11/resposta11.png");
    resposta2=al_load_bitmap("recursos/pergunta11/resposta2.png");
    resposta22=al_load_bitmap("recursos/pergunta11/resposta22.png");
    resposta3=al_load_bitmap("recursos/pergunta11/resposta3.png");
    resposta33=al_load_bitmap("recursos/pergunta11/resposta33.png");
    resposta4=al_load_bitmap("recursos/pergunta11/resposta4.png");
    resposta44=al_load_bitmap("recursos/pergunta11/resposta44.png");
    resposta5=al_load_bitmap("recursos/pergunta11/resposta5.png");
    resposta55=al_load_bitmap("recursos/pergunta11/resposta55.png");
    resposta_correta=al_load_bitmap("recursos/pergunta11/respostacorreta.png");
    ...
    while(!sair)/**SAIR JO JOGO*/
    {
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)///CASO CLIQUE NA RESPOSTA
        {
            if(evento.mouse.x > LARGURA*0.144 && evento.mouse.x < LARGURA*0.144 + al_get_bitmap_width(resposta1))
            {
                if(evento.mouse.y > ALTURA*0.494 && evento.mouse.y < ALTURA*0.494 + al_get_bitmap_height(resposta1))
                {
                    ...
                    ponto=1;///E VERDADEIRO RECEBE 1 PARA NAO PASSAR PELA RESPOSTA ERRADA
                }
            }
        }
        if(opcao2)
        ...
        if(evento.type == ALLEGRO_EVENT_MOUSE_BUTTON_UP)/**SE CLICAR NA PERGUNTA*/
        {
            ...
            {
                if(evento.mouse.y > ALTURA*0.916 && evento.mouse.y < ALTURA*0.916 + al_get_bitmap_height(resposta5))
                {
                    ponto=0;
                }
            }
        ...
        switch (ponto)///SE RESPOSTA ESTIVER ERRADA MOSTRAR A CORRETA
            ...
            case 0:
                ...
                al_draw_bitmap(resposta_correta,LARGURA*0.144, ALTURA*0.494,0);///RESPOSTA CORRETA
                al_flip_display();
